...
c1 = Chart.create!(question_id: 1, format: 1)
c2 = Chart.create!(question_id: 2, format: 1)
c3 = Chart.create!(question_id: 3, format: 1)
c4 = Chart.create!(question_id: 4, format: 1)
c5 = Chart.create!(question_id: 5, format: 1)
c6 = Chart.create!(question_id: 6, format: 1)
c7 = Chart.create!(question_id: 7, format: 1)
